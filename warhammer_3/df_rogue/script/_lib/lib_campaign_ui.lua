...
--- class campaign_ui_manager campaign_ui_manager Campaign UI Manager
...
--- return @string open blocking panel
...
--- return @string selected settlement name
...
--- return @string selected settlement region name
...
function campaign_ui_manager:highlight_character_details_panel_abilities(value, pulse_strength, force_highlight, do_not_highlight_upstream)
	...
	local uic = find_uicomponent(core:get_ui_root(), "character_details_panel", "stats_effects_holder", "unit_information");
...
function campaign_ui_manager:highlight_war_coordination(value, pulse_strength, force_highlight)
	...
	local uic_war_coordination_panel = find_uicomponent(ui_root, "diplomacy_dropdown", "panel_war_coordination");
	...
	if uic_war_coordination_panel and uic_war_coordination_panel:Visible(true) then
		pulse_uicomponent(uic_war_coordination_panel, value, pulse_strength or self.panel_pulse_strength, true);
		
		if value then
			table.insert(self.unhighlight_action_list, function() self:highlight_war_coordination(false, pulse_strength, force_highlight) end);
		end;
	elseif uic_war_coordination_button and uic_war_coordination_button:Visible(true) then
